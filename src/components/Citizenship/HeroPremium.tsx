...
export default function HeroPremium({
  ...
  features = ["Dedicated due-diligence desk", "Discreet & confidential", "Project vetting"],
  align = "left",
}: Props) {
  ...
  const alignClasses =
    align === "center"
      ? "text-center md:max-w-3xl mx-auto"
      : "text-left";
  ...
  return (
    ...
    >
      ...
      <div className={`relative ${alignClasses}`}>
        ...
        {/* Title */}
        <h1 id={heroId} className="mt-3 text-3xl md:text-4xl lg:text-5xl font-semibold tracking-tight leading-tight">
          {title}
        </h1>
        ...
        {/* CTAs */}
        <div className={`mt-6 flex flex-wrap items-center gap-3 ${align === "center" ? "justify-center" : ""}`}>
          <Link
            href={primaryHref}
            prefetch={false}
