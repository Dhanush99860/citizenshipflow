...
export default function AdvisorSpotlight({
  ...
  return (
    <section
      className={`rounded-2xl bg-white/80 dark:bg-neutral-900/40 ring-1 ring-neutral-200 dark:ring-neutral-800 p-6 sm:p-7 ${className}`}
    >
          ...
          <div className="mt-3 flex flex-wrap gap-3">
            ...
            {brochureUrl ? (
              <a
                href={brochureUrl}
                download
                className="rounded-xl ring-1 ring-neutral-300 dark:ring-neutral-700 bg-white/80 dark:bg-neutral-900 px-4 py-2 hover:bg-neutral-100 dark:hover:bg-neutral-800"
              >
                Download Brochure
              </a>
            ) : null}
