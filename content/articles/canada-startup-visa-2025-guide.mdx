...
<FAQSection
  faqs={[
    { q: "Can I include my family?", a: "Yes. Spouses/partners and dependent children can be included for permanent residence." },
    { q: "How many founders can apply?", a: "Up to five owners. A DO may mark certain founders as essential; if an essential applicant is refused or withdraws, the file can be refused." },
    { q: "Do I need to invest a fixed amount?", a: "There is no fixed government investment; terms depend on your designated organization and company needs." },
    { q: "Is French required?", a: "No. You must reach at least CLB 5 in one official language (English or French)." },
    { q: "Can I live in Québec on SUV?", a: "No. SUV is federal for all provinces/territories except Québec." },
    { q: "What if my LoS expires while IRCC is processing?", a: "Coordinate with your designated organization for re-issuance or an extension letter." },
  ]}
/>
